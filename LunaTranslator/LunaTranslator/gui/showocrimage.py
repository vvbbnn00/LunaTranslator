...
class showocrimage(closeashidewindow):
    ...
    def showimg(self):
        ...
        self.originlabel.setPixmap(
            self.img1.scaled(self.originlabel.size(), Qt.KeepAspectRatio, Qt.SmoothTransformation))
        self.solvedlabel.setPixmap(
            self.img2.scaled(self.solvedlabel.size(), Qt.KeepAspectRatio, Qt.SmoothTransformation))
