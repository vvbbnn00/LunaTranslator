...
from PyQt5.QtWidgets import QApplication, QTextBrowser, QMainWindow, QFontDialog, QAction, QMenu, QHBoxLayout, QWidget, \
...
class edittext(closeashidewindow):
    ...
    def setupUi(self):
        ...
        bt2 = QPushButton(icon=qtawesome.icon("fa.forward" if self.sync else 'fa.play',
    ...
    def changestate(self):
        ...
        self.bt2.setIcon(qtawesome.icon("fa.forward" if self.sync else 'fa.play',
                                        color="#FF69B4" if self.sync else globalconfig['buttoncolor']))
