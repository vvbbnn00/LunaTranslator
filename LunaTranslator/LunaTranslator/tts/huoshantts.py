...
class TTS(TTSbase):
    def getvoicelist(self):
        return ['jp_male_satoshi', 'jp_female_mai', 'zh_male_rap', 'zh_female_sichuan', 'zh_male_xiaoming',
                'zh_male_zhubo', 'zh_female_zhubo', 'zh_female_qingxin', 'zh_female_story', 'en_male_adam',
                'en_male_bob', 'en_female_sarah']
