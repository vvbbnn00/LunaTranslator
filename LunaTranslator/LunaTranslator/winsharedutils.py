from ctypes import c_uint, c_bool, POINTER, c_char_p, c_uint64, c_wchar_p, pointer, CDLL, c_int, Structure, c_void_p, \
    cast, memmove, create_unicode_buffer, create_string_buffer, c_size_t, windll
import os, gobject
