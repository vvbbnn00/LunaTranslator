...
class OCR(baseocr):
    ...
    def check(self):
        ...
        if (app_id, app_secret) not in self.tokens:
            res = self.session.post('https://open.feishu.cn/open-apis/auth/v3/tenant_access_token/internal',
    ...
    def ocr(self, imgfile):
        ...
        res = self.session.post('https://open.feishu.cn/open-apis/optical_char_recognition/v1/image/basic_recognize',
