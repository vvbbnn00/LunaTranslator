...
class OCR(baseocr):
    ...
    def ocr(self, imgfile):
        ...
        region = ["ap-beijing", "ap-shanghai", "ap-chengdu", "ap-chongqing", "ap-guangzhou", "ap-hongkong", "ap-mumbai",
        ...
        authorization = algorithm + ' ' + 'Credential=' + self.config[
            'SecretId'] + '/' + credentialScope + ', ' + 'SignedHeaders=' + signedHeaders + ', ' + 'Signature=' + signature;
        ...
        try:
            boxs = [(_['X'], _['Y'], _['X'] + _['W'], _['Y'] + _['H']) for _ in
                    r.json()['Response']['ImageRecord']['Value']]
